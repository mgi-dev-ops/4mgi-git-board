...
export function DiffSection({
  ...
  const selectedFiles = activeTab === "staged" ? selectedStaged : selectedUnstaged;
  const setSelectedFiles = activeTab === "staged" ? setSelectedStaged : setSelectedUnstaged;
  ...
  return (
    <div className={`${styles.diffSection} ${isCollapsed ? styles.collapsed : ""}`}>
