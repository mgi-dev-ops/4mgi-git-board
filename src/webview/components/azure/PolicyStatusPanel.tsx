	...
	return (
		<section className={panelClasses}>
			...
			<div className={styles.summary}>
				<div
					className={`${styles.summaryBadge} ${allPoliciesSatisfied ? styles.satisfied : styles.notSatisfied}`}
				>
				...
				<div className={styles.summaryStats}>
					...
					{rejectedCount > 0 && (
						<span className={styles.statRejected}>{rejectedCount} failed</span>
					)}
					{pendingCount > 0 && (
				...
				<ul className={styles.policyList}>
					{policies.map((policy) => {
						...
						return (
							...
							>
								<span
									className={`${styles.statusIcon} ${styles[statusInfo.className]}`}
								>
									{statusInfo.icon}
								</span>
								<div className={styles.policyContent}>
									...
									{policy.details && (
										<span className={styles.policyDetails}>
											{policy.details}
										</span>
									)}
								</div>
