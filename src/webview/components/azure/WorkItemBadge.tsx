...
export type WorkItemType = "bug" | "task" | "userStory" | "feature" | "epic" | "issue" | "testCase";
...
const typeConfig: Record<WorkItemType, { icon: React.ReactNode; label: string; color: string }> = {
  bug: {
    icon: (
