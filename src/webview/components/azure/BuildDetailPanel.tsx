...
import { type BuildStatus, BuildStatusBadge } from './BuildStatusBadge';
						...
						{testPassRate !== null && (
							<div className={styles.testProgressContainer}>
								<div
									...
									title={`${testPassRate}% tests passed`}
								>
									<div
			...
			{codeCoverage !== undefined && (
				<div className={styles.section}>
					...
					<div className={styles.coverageContainer}>
						<div
							className={styles.coverageProgressBar}
							title={`${codeCoverage}% code coverage`}
						>
							<div
			...
			{requestedBy && (
				<div className={styles.section}>
					...
					<div className={styles.requestedByRow}>
						...
						<span className={styles.requestedByName}>
