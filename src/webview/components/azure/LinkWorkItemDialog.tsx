...
export const LinkWorkItemDialog: React.FC<LinkWorkItemDialogProps> = ({
	...
	const [activeTab, setActiveTab] = useState<'search' | 'id' | 'recent'>(
		'search',
	);
	...
	return (
		...
		>
			<div
				...
				role="dialog"
				aria-modal="true"
				aria-labelledby="link-workitem-title"
			>
				{/* Header */}
				<div className={styles.header}>
					<div className={styles.headerContent}>
						<h2 id="link-workitem-title" className={styles.title}>
							Link Work Item
						</h2>
						{commitSha && (
						...
						<div className={styles.workItemListContainer}>
							{displayItems.length > 0 ? (
								...
								<div className={styles.emptyState}>
									...
									{activeTab === 'recent' && <p>No recent work items</p>}
								</div>
							)}
						</div>
					)}
