...
import { PRBadge, type PRStatus } from './PRBadge';
...
> = {
	...
	approvedWithSuggestions: {
		icon: 'check-suggestions',
		label: 'Approved with suggestions',
		className: 'voteApprovedWithSuggestions',
	},
	waitingForAuthor: {
		icon: 'waiting',
						...
						return (
							<li key={reviewer.id} className={styles.reviewerItem}>
								...
								<span className={styles.reviewerName}>
									...
									{reviewer.isRequired && (
										<span className={styles.required} title="Required reviewer">
											*
										</span>
									)}
								</span>
