...
import { BranchContextMenu, type ContextMenuAction } from './BranchContextMenu';
...
export function BranchList({
	...
	const { localBranches, remoteBranches } = useMemo(() => {
		...
		branches.forEach((branch) => {
			...
			const isRemoteOnly =
				!!branch.remote && !branch.tracking && branch.name.includes('/');
	...
	return (
		<div className={styles.branchListContainer}>
			...
			<div className={styles.treeContainer}>
				<ul className={styles.tree} aria-label="Branch list">
