...
export function CreateBranchDialog({
  ...
  const handleSubmit = useCallback(
    ...
    [branchName, selectedSource, checkoutAfterCreate, validateBranchName, onCreate, onClose]
  );
  ...
  return (
    <div className={styles.dialogOverlay} role="dialog" aria-modal="true" aria-labelledby="create-branch-title">
          ...
          <div className={styles.dialogContent}>
            ...
            <div className={styles.formGroup}>
              <div className={styles.checkboxGroup}>
                ...
                />
                <label htmlFor="checkout-after-create" className={styles.checkboxLabel}>
