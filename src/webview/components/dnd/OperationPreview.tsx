...
export const OperationPreview: React.FC<OperationPreviewProps> = ({
  ...
  const warning = operation.warning || (source && target ? getOperationWarning(source, target) : undefined);

  return (
    <div className={styles.operationPreviewOverlay} role="dialog" aria-modal="true">
      <div className={styles.operationPreviewModal}>
        ...
        {/* Warning */}
        {warning && (
          <div className={`${styles.previewWarning} ${isDangerous ? styles.warningDanger : ''}`}>
            <WarningIcon />
            <span>{warning}</span>
          </div>
        )}
        ...
        <div className={styles.previewVisualization}>
          <div className={styles.visualizationPane}>
            ...
            <div className={styles.visualizationContent}>
              <BeforePreview source={source} target={target} operation={operation} />
            </div>
          </div>
          ...
          <div className={styles.visualizationPane}>
            ...
            <div className={styles.visualizationContent}>
              <AfterPreview source={source} target={target} operation={operation} />
            </div>
          </div>
        </div>
...
const BeforePreview: React.FC<PreviewProps> = ({ source, target, operation }) => {
  return (
...
const AfterPreview: React.FC<PreviewProps> = ({ source, target, operation }) => {
  return (
    <div className={styles.graphPreview}>
...
function renderBeforeGraph(
  ...
  switch (operation.operation) {
    ...
    default:
      return <span className={styles.previewPlaceholder}>Preview not available</span>;
  }
}
...
function renderRebaseBeforeGraph(source: DragSource, target: DropTarget): React.ReactNode {
  const sourceHash = source.type === 'commit' ? source.commit.shortHash : source.type === 'branch' ? source.branch.name : '???';
  const targetHash = target.type === 'commit' ? target.commit.shortHash : '???';

  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      {/* Main branch line */}
      <line x1="20" y1="50" x2="180" y2="50" stroke="var(--branch-main)" strokeWidth="2" />
      {/* Source branch diverging */}
      <line x1="80" y1="50" x2="140" y2="20" stroke="var(--branch-feature)" strokeWidth="2" />
      {/* Commits */}
      ...
      {/* Labels */}
      <text x="80" y="70" fontSize="10" fill="currentColor" textAnchor="middle">base</text>
      <text x="160" y="70" fontSize="10" fill="currentColor" textAnchor="middle">{targetHash}</text>
      <text x="140" y="12" fontSize="10" fill="currentColor" textAnchor="middle">{sourceHash}</text>
    </svg>
  );
}

function renderRebaseAfterGraph(source: DragSource, target: DropTarget): React.ReactNode {
  const sourceHash = source.type === 'commit' ? source.commit.shortHash : source.type === 'branch' ? source.branch.name : '???';
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      {/* Labels */}
      <text x="160" y="70" fontSize="10" fill="currentColor" textAnchor="middle">{sourceHash}'</text>
      <text x="160" y="35" fontSize="9" fill="var(--success-green)" textAnchor="middle">rebased</text>
    </svg>
  );
}

function renderCherryPickBeforeGraph(source: DragSource, target: DropTarget): React.ReactNode {
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      {/* Source branch */}
      <line x1="20" y1="30" x2="180" y2="30" stroke="var(--branch-feature)" strokeWidth="2" />
      {/* Target branch */}
      <line x1="20" y1="70" x2="140" y2="70" stroke="var(--branch-main)" strokeWidth="2" />
      {/* Source commits */}
      <circle cx="100" cy="30" r="6" fill="var(--branch-feature)" stroke="var(--warning-yellow)" strokeWidth="2" />
      {/* Target commits */}
      ...
      {/* Labels */}
      <text x="100" y="18" fontSize="10" fill="currentColor" textAnchor="middle">{sourceHash}</text>
      <text x="140" y="88" fontSize="10" fill="currentColor" textAnchor="middle">{targetBranch}</text>
    </svg>
  );
}

function renderCherryPickAfterGraph(source: DragSource, target: DropTarget): React.ReactNode {
  const sourceHash = source.type === 'commit' ? source.commit.shortHash : '???';
  const targetBranch = target.type === 'branch' ? target.branch.name : '???';
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      <line x1="20" y1="70" x2="180" y2="70" stroke="var(--branch-main)" strokeWidth="2" />
      {/* Source commit */}
      ...
      <circle cx="100" cy="70" r="6" fill="var(--branch-main)" />
      <circle cx="140" cy="70" r="6" fill="var(--branch-main)" />
      <circle cx="180" cy="70" r="6" fill="var(--success-green)" stroke="var(--success-green)" strokeWidth="2" />
      {/* Labels */}
      <text x="180" y="88" fontSize="10" fill="currentColor" textAnchor="middle">{sourceHash}'</text>
      <text x="180" y="55" fontSize="9" fill="var(--success-green)" textAnchor="middle">picked</text>
    </svg>
  );
}

function renderMergeBeforeGraph(source: DragSource, target: DropTarget): React.ReactNode {
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      <line x1="20" y1="70" x2="140" y2="70" stroke="var(--branch-main)" strokeWidth="2" />
      {/* Source branch diverging */}
      <line x1="60" y1="70" x2="60" y2="30" stroke="var(--branch-feature)" strokeWidth="2" />
      <line x1="60" y1="30" x2="140" y2="30" stroke="var(--branch-feature)" strokeWidth="2" />
      {/* Commits */}
      <circle cx="60" cy="70" r="6" fill="var(--branch-main)" />
      <circle cx="100" cy="70" r="6" fill="var(--branch-main)" />
      <circle cx="140" cy="70" r="6" fill="var(--branch-main)" />
      ...
      {/* Labels */}
      <text x="140" y="88" fontSize="10" fill="currentColor" textAnchor="middle">{targetBranch}</text>
      <text x="140" y="18" fontSize="10" fill="currentColor" textAnchor="middle">{sourceBranch}</text>
    </svg>
  );
}

function renderMergeAfterGraph(source: DragSource, target: DropTarget): React.ReactNode {
  const targetBranch = target.type === 'branch' ? target.branch.name : '???';
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      <line x1="60" y1="70" x2="60" y2="30" stroke="var(--branch-feature)" strokeWidth="2" />
      <line x1="60" y1="30" x2="140" y2="30" stroke="var(--branch-feature)" strokeWidth="2" />
      <line x1="140" y1="30" x2="180" y2="70" stroke="var(--branch-feature)" strokeWidth="2" />
      {/* Commits */}
      <circle cx="60" cy="70" r="6" fill="var(--branch-main)" />
      <circle cx="100" cy="70" r="6" fill="var(--branch-main)" />
      <circle cx="140" cy="70" r="6" fill="var(--branch-main)" />
      ...
      {/* Labels */}
      <text x="180" y="88" fontSize="10" fill="currentColor" textAnchor="middle">{targetBranch}</text>
      <text x="180" y="55" fontSize="9" fill="var(--success-green)" textAnchor="middle">merge</text>
    </svg>
  );
}

function renderMoveBranchBeforeGraph(source: DragSource, target: DropTarget): React.ReactNode {
  const branchName = source.type === 'branch-pointer' ? source.branch.name : '???';
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      <text x="80" y="30" fontSize="10" fill="var(--branch-feature)" textAnchor="middle">{branchName}</text>
      <line x1="80" y1="32" x2="80" y2="42" stroke="var(--branch-feature)" strokeWidth="1" markerEnd="url(#arrow)" />
    </svg>
  );
}

function renderMoveBranchAfterGraph(source: DragSource, target: DropTarget): React.ReactNode {
  const branchName = source.type === 'branch-pointer' ? source.branch.name : '???';
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      <text x="160" y="30" fontSize="10" fill="var(--success-green)" textAnchor="middle">{branchName}</text>
      <line x1="160" y1="32" x2="160" y2="42" stroke="var(--success-green)" strokeWidth="1" />
    </svg>
  );
}
...
function renderCreateBranchBeforeGraph(source: DragSource): React.ReactNode {
  ...
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      ...
      <circle cx="40" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="80" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="120" cy="50" r="6" fill="var(--branch-main)" stroke="var(--warning-yellow)" strokeWidth="2" />
      <circle cx="160" cy="50" r="6" fill="var(--branch-main)" />
      {/* Label */}
      <text x="120" y="70" fontSize="10" fill="currentColor" textAnchor="middle">{sourceHash}</text>
    </svg>
  );
}

function renderCreateBranchAfterGraph(source: DragSource): React.ReactNode {
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      {/* Main line */}
      <line x1="20" y1="50" x2="180" y2="50" stroke="var(--branch-main)" strokeWidth="2" />
      {/* New branch line */}
      <line x1="120" y1="50" x2="180" y2="20" stroke="var(--success-green)" strokeWidth="2" strokeDasharray="4" />
      {/* Commits */}
      <circle cx="40" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="80" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="120" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="160" cy="50" r="6" fill="var(--branch-main)" />
      {/* New branch label */}
      <text x="160" y="15" fontSize="10" fill="var(--success-green)" textAnchor="middle">new-branch</text>
    </svg>
  );
}

function renderReorderBeforeGraph(source: DragSource, target: DropTarget): React.ReactNode {
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      {/* Main line */}
      <line x1="20" y1="50" x2="180" y2="50" stroke="var(--branch-main)" strokeWidth="2" />
      ...
      <circle cx="40" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="80" cy="50" r="6" fill="var(--branch-main)" />
      <circle cx="120" cy="50" r="6" fill="var(--warning-yellow)" stroke="var(--warning-yellow)" strokeWidth="2" />
      <circle cx="160" cy="50" r="6" fill="var(--branch-main)" />
      {/* Labels */}
      <text x="40" y="70" fontSize="10" fill="currentColor" textAnchor="middle">1</text>
      <text x="80" y="70" fontSize="10" fill="currentColor" textAnchor="middle">2</text>
      <text x="120" y="70" fontSize="10" fill="currentColor" textAnchor="middle">3</text>
      <text x="160" y="70" fontSize="10" fill="currentColor" textAnchor="middle">4</text>
    </svg>
  );
}

function renderReorderAfterGraph(source: DragSource, target: DropTarget): React.ReactNode {
  return (
    <svg width="200" height="100" viewBox="0 0 200 100" className={styles.miniGraph}>
      {/* Main line */}
      <line x1="20" y1="50" x2="180" y2="50" stroke="var(--branch-main)" strokeWidth="2" />
      ...
      {/* Labels */}
      <text x="40" y="70" fontSize="10" fill="currentColor" textAnchor="middle">1</text>
      <text x="80" y="70" fontSize="10" fill="currentColor" textAnchor="middle">3'</text>
      <text x="120" y="70" fontSize="10" fill="currentColor" textAnchor="middle">2'</text>
      <text x="160" y="70" fontSize="10" fill="currentColor" textAnchor="middle">4'</text>
    </svg>
  );
}
...
const WarningIcon: React.FC = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    <path d="M7.56 1.46L.5 13.5a.5.5 0 00.44.75h14.12a.5.5 0 00.44-.75L8.44 1.46a.5.5 0 00-.88 0zM8 5v4M8 11v1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
  </svg>
);
...
const LoadingSpinner: React.FC = () => (
  <svg className={styles.spinner} width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <path d="M8 2C4.69 2 2 4.69 2 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
export interface UseOperationPreviewReturn {
  ...
  target: DropTarget | null;
  operation: OperationInfo | null;
  showPreview: (source: DragSource, target: DropTarget, operation: OperationInfo) => void;
  hidePreview: () => void;
  isExecuting: boolean;
...
export function useOperationPreview(): UseOperationPreviewReturn {
  ...
  const showPreview = useCallback(
    (newSource: DragSource, newTarget: DropTarget, newOperation: OperationInfo) => {
      setSource(newSource);
      setTarget(newTarget);
