...
export type CommitStatus = 'pending' | 'in_progress' | 'completed' | 'dropped' | 'conflict' | 'skipped';
...
export interface ActionLabels {
  pick: { standard: string; simplified: string; icon: string; shortcut: string };
  reword: { standard: string; simplified: string; icon: string; shortcut: string };
  edit: { standard: string; simplified: string; icon: string; shortcut: string };
  squash: { standard: string; simplified: string; icon: string; shortcut: string };
  fixup: { standard: string; simplified: string; icon: string; shortcut: string };
  drop: { standard: string; simplified: string; icon: string; shortcut: string };
}
...
export const ACTION_LABELS: ActionLabels = {
  ...
  reword: { standard: 'reword', simplified: 'Edit Message', icon: '\u270F\uFE0F', shortcut: 'r' },
  edit: { standard: 'edit', simplified: 'Edit Code', icon: '\u23F8\uFE0F', shortcut: 'e' },
  squash: { standard: 'squash', simplified: 'Merge (keep messages)', icon: '\uD83D\uDD17', shortcut: 's' },
  fixup: { standard: 'fixup', simplified: 'Merge (discard message)', icon: '\uD83D\uDD27', shortcut: 'f' },
  drop: { standard: 'drop', simplified: 'Delete', icon: '\uD83D\uDDD1\uFE0F', shortcut: 'd' },
};
...
export const ACTION_TOOLTIPS: ActionTooltips = {
  ...
  edit: {
    ...
    description: "Rebase will stop here. Make changes, then run 'Continue Rebase'.",
  },
  squash: {
    title: 'Combine with previous commit',
    description: "Merges into the commit above. You'll edit the combined message.",
  },
  fixup: {
    title: 'Combine, remove this message',
    description: 'Merges into the commit above. Only the previous message is kept.',
  },
  drop: {
