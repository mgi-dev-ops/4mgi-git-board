    ...
    <div className={styles.toolbar}>
      ...
      <div className={styles.dropdownContainer}>
        ...
        {isBranchDropdownOpen && (
          <ul className={styles.dropdown} role="listbox" aria-label="Branches">
            {branches.length > 0 ? (
              branches.map((branch) => (
                <li
                  key={branch.name}
              ...
              <li className={styles.dropdownItemEmpty}>No branches available</li>
            )}
          </ul>
        )}
      </div>
      ...
      <div className={styles.dropdownContainer}>
        ...
        {isStashDropdownOpen && (
          <ul className={styles.dropdown} role="listbox" aria-label="Stashes">
            {stashes.length > 0 ? (
              stashes.map((stash) => (
                <li
                  key={stash.index}
