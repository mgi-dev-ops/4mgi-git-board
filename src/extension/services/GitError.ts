...
const ERROR_MESSAGES: Record<GitErrorCode, string> = {
	...
	[GitErrorCode.LOCK_FILE_EXISTS]:
		'Repository is locked. Another git process may be running',
	...
	[GitErrorCode.SHALLOW_CLONE_LIMIT]:
		'Operation not supported on shallow clone',
...
export function parseGitError(error: unknown): GitError {
	...
	return new GitError(
		GitErrorCode.UNKNOWN_GIT_ERROR,
		originalError,
		errorMessage,
	);
}
