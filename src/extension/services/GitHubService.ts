...
export class GitHubService {
   ...
   */
  async getRepositoryFromUrl(remoteUrl: string): Promise<GitHubRepository | null> {
 ...
 */
export function getGitHubService(context: vscode.ExtensionContext): GitHubService {
  if (!instance) {
